...
private slots:
	...
	void DrawMoveVertices();
	void DrawCage();
	void GenerateDeformation();
	void GenerateVariationalDeform();
	void GenerateDeformByControlPoint();
	void OptimizeControlPoints();
	void RecordOriginMesh();
	void ReadIntegralParaFromFile();
	void ReadCageFromFile();
	void ComputeParaForControlPoints();
	void GenerateParaCompleteFlow();
	void pointPick();
	void vertexPick();
	void edgePick();
	void facePick();
	...
	void movePositionConstraints();
	void selectMoveControlPoints();
...
private:
	...
	QAction* recordOriginMeshAction;
	QAction* readIntegralParaFromFilesAction;
	QAction* readCageFromFileAction;
	QAction* ComputeParaForControlPointsAction;
	QAction* GenerateParaCompleteFlowAction;
	...
	QAction* changeCageModeAction;
	QAction* drawControlPointAction;
	QAction* drawMoveVerticesAction;
	QAction* drawCageAction;
	QAction* GenerateDeformedMeshAction;
	QAction* GenerateVariationalDeformAction;
	QAction* GenerateDeformByControlPointAction;
	QAction* OptimizeControlPointsAction;
	...
	QAction* moveControlPointAction;
	QAction* movePositionConstraintsAction;
	QAction* selectMoveControlPointsAction;
	QAction* moveControlPointsAction;
	QAction* clearSelectPointsAction;
