...
public:
	enum {
		TRANS, POINTPICK, VERTEXPICK, EDGEPICK, FACEPICK, EDGECOLLAPSE, EDGEFLIP,
		EDGESPLIT, MOVE, MOVE_CONTROL_POINT, MOVE_POSITION_CONSTRAINTS, SELECT_MOVE_CONTROL_POINTS,
		MOVE_CONTROL_POINTS, T2_MODE, N_MODE
	};
...
protected:
	...
	void pick_control_point();
	void pick_position_constraints();
	...
	void move_control_point_based_selected_control_point(int x, int y);
	void move_position_constraints_based_selected_position_constraints(int x, int y);
	void move_selected_control_points(int x, int y);
	...
	void draw_selected_control_point();
	void draw_selected_position_constraints();
	void draw_selected_control_points();
...
protected:
	...
	int selectedPositionConstraint = -1;
	std::vector<int> selectedControlPoints;
	Mesh::Point mid_point = { 0,0,0 };
