...
void SurfaceMeshProcessing::createActions()
{
	...
	changeCageModeAction = new QAction("Change Cage Mode Tri/Quad", this);
	changeCageModeAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/changecagemode.png"));
	changeCageModeAction->setStatusTip(tr("Change Cage Mode Tri/Quad"));
	connect(changeCageModeAction, SIGNAL(triggered()), this, SLOT(ChangeCageMode()));

	drawControlPointAction = new QAction("Draw Control Point", this);
	drawControlPointAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/controlpoint.png"));
	drawControlPointAction->setStatusTip(tr("Draw Control Point"));
	connect(drawControlPointAction, SIGNAL(triggered()), this, SLOT(DrawControlPoint()));

	drawMoveVerticesAction = new QAction("Draw Move Vertices Action", this);
	drawMoveVerticesAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/movevertices.png"));
	drawMoveVerticesAction->setStatusTip(tr("Draw Move Vertices Action"));
	connect(drawMoveVerticesAction, SIGNAL(triggered()), this, SLOT(DrawMoveVertices()));

	drawCageAction = new QAction("Draw Cage", this);
	drawCageAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/cage.png"));
	drawCageAction->setStatusTip(tr("Draw Cage"));
	connect(drawCageAction, SIGNAL(triggered()), this, SLOT(DrawCage()));

	GenerateDeformedMeshAction = new QAction("Generate Deformed Mesh", this);
	GenerateDeformedMeshAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/deformation.png"));
	GenerateDeformedMeshAction->setStatusTip(tr("Generate Deformed Mesh"));
	GenerateDeformedMeshAction->setCheckable(true);
	GenerateDeformedMeshAction->setChecked(false);
	connect(GenerateDeformedMeshAction, SIGNAL(triggered()), this, SLOT(GenerateDeformation()));

	GenerateVariationalDeformAction = new QAction("Generate Variational Deformation", this);
	GenerateVariationalDeformAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/variationaldeformation.png"));
	GenerateVariationalDeformAction->setStatusTip(tr("Generate Variational Deformation"));
	GenerateVariationalDeformAction->setCheckable(true);
	GenerateVariationalDeformAction->setChecked(false);
	connect(GenerateVariationalDeformAction, SIGNAL(triggered()), this, SLOT(GenerateVariationalDeform()));

	GenerateDeformByControlPointAction = new QAction("Generate Deformation By Control Points", this);
	GenerateDeformByControlPointAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/deformation.png"));
	GenerateDeformByControlPointAction->setStatusTip(tr("Generate Deformation By Control Points"));
	GenerateDeformByControlPointAction->setCheckable(true);
	GenerateDeformByControlPointAction->setChecked(false);
	connect(GenerateDeformByControlPointAction, SIGNAL(triggered()), this, SLOT(GenerateDeformByControlPoint()));

	OptimizeControlPointsAction = new QAction("Optimize Control Points", this);
	OptimizeControlPointsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/optimizecontrolpoints.png"));
	OptimizeControlPointsAction->setStatusTip(tr("Optimize Control Points"));
	OptimizeControlPointsAction->setCheckable(true);
	OptimizeControlPointsAction->setChecked(false);
	connect(OptimizeControlPointsAction, SIGNAL(triggered()), this, SLOT(OptimizeControlPoints()));
	...
	recordOriginMeshAction = new QAction(tr("Record Origin Mesh"), this);
	recordOriginMeshAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/recordoriginmesh.png"));
	recordOriginMeshAction->setStatusTip(tr("Record Origin Mesh"));
	connect(recordOriginMeshAction, SIGNAL(triggered()), this, SLOT(RecordOriginMesh()));

	readIntegralParaFromFilesAction = new QAction(tr("Read Integral Para From Files"), this);
	readIntegralParaFromFilesAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/readintegralpara.png"));
	readIntegralParaFromFilesAction->setStatusTip(tr("Read Integral Para From Files"));
	connect(readIntegralParaFromFilesAction, SIGNAL(triggered()), this, SLOT(ReadIntegralParaFromFile()));

	readCageFromFileAction = new QAction(tr("Read Cage From File"), this);
	readCageFromFileAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/readcage.png"));
	readCageFromFileAction->setStatusTip(tr("Read Cage From File"));
	connect(readCageFromFileAction, SIGNAL(triggered()), this, SLOT(ReadCageFromFile()));

	ComputeParaForControlPointsAction = new QAction(tr("Compute Para For Control Points"), this);
	ComputeParaForControlPointsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/computeparaforcontrolpoints.png"));
	ComputeParaForControlPointsAction->setStatusTip(tr("Compute Para For Control Points"));
	connect(ComputeParaForControlPointsAction, SIGNAL(triggered()), this, SLOT(ComputeParaForControlPoints()));

	GenerateParaCompleteFlowAction = new QAction(tr("Generate Para Complete Flow"), this);
	GenerateParaCompleteFlowAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/completeflow.png"));
	GenerateParaCompleteFlowAction->setStatusTip(tr("Generate Para Complete Flow"));
	connect(GenerateParaCompleteFlowAction, SIGNAL(triggered()), this, SLOT(GenerateParaCompleteFlow()));
	...
	moveControlPointAction = new QAction(tr("&Move Control Point"), this);
	moveControlPointAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/move_control_point.png"));
	moveControlPointAction->setStatusTip(tr("Move Control Point"));
	moveControlPointAction->setCheckable(true);
	moveControlPointAction->setChecked(false);
	connect(moveControlPointAction, SIGNAL(triggered()), this, SLOT(moveControlPoint()));

	movePositionConstraintsAction = new QAction(tr("&Move Position Constraints"), this);
	movePositionConstraintsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/move_control_point.png"));
	movePositionConstraintsAction->setStatusTip(tr("Move Position Constraints"));
	movePositionConstraintsAction->setCheckable(true);
	movePositionConstraintsAction->setChecked(false);
	connect(movePositionConstraintsAction, SIGNAL(triggered()), this, SLOT(movePositionConstraints()));

	selectMoveControlPointsAction = new QAction(tr("&Select Move Control Points"), this);
	selectMoveControlPointsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/select_move_control_points.png"));
	selectMoveControlPointsAction->setStatusTip(tr("Select Move Control Points"));
	selectMoveControlPointsAction->setCheckable(true);
	selectMoveControlPointsAction->setChecked(false);
	connect(selectMoveControlPointsAction, SIGNAL(triggered()), this, SLOT(selectMoveControlPoints()));

	moveControlPointsAction = new QAction(tr("&Move Control Points"), this);
	moveControlPointsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/move_control_point.png"));
	moveControlPointsAction->setStatusTip(tr("Move Control Points"));
	moveControlPointsAction->setCheckable(true);
	moveControlPointsAction->setChecked(false);
	connect(moveControlPointsAction, SIGNAL(triggered()), this, SLOT(moveControlPoints()));

	clearSelectPointsAction = new QAction(tr("&Clear Selected Points"), this);
	clearSelectPointsAction->setIcon(QIcon(":/SurfaceMeshProcessing/Images/clear_select_points.png"));
	clearSelectPointsAction->setStatusTip(tr("Clear Selected Points"));
	connect(clearSelectPointsAction, SIGNAL(triggered()), this, SLOT(clearSelectPoints()));
...
void SurfaceMeshProcessing::createMenus()
{
	...
	fileMenu->addSeparator();
	fileMenu->addAction(readIntegralParaFromFilesAction);
	fileMenu->addAction(readCageFromFileAction);
	fileMenu->addAction(ComputeParaForControlPointsAction);
	fileMenu->addAction(GenerateParaCompleteFlowAction);
	...
	viewMenu->addAction(changeCageModeAction);
	viewMenu->addAction(drawControlPointAction);
	viewMenu->addAction(drawMoveVerticesAction);
	viewMenu->addAction(drawCageAction);
	viewMenu->addAction(GenerateDeformedMeshAction);
	viewMenu->addAction(GenerateVariationalDeformAction);
	viewMenu->addAction(GenerateDeformByControlPointAction);
	viewMenu->addAction(OptimizeControlPointsAction);
	viewMenu->addAction(recordOriginMeshAction);
	...
	mouseMenu->addAction(moveControlPointAction);
	mouseMenu->addAction(movePositionConstraintsAction);
	mouseMenu->addAction(moveControlPointsAction);
	mouseMenu->addAction(selectMoveControlPointsAction);
	mouseMenu->addAction(clearSelectPointsAction);
...
void SurfaceMeshProcessing::createToolBars()
{
	...
	fileToolBar->addAction(readIntegralParaFromFilesAction);
	fileToolBar->addAction(readCageFromFileAction);
	fileToolBar->addAction(ComputeParaForControlPointsAction);
	fileToolBar->addAction(GenerateParaCompleteFlowAction);
	...
	otherViewBar->addAction(changeCageModeAction);
	otherViewBar->addAction(drawControlPointAction);
	otherViewBar->addAction(drawMoveVerticesAction);
	otherViewBar->addAction(drawCageAction);
	otherViewBar->addAction(GenerateDeformedMeshAction);
	otherViewBar->addAction(GenerateVariationalDeformAction);
	otherViewBar->addAction(GenerateDeformByControlPointAction);
	otherViewBar->addAction(OptimizeControlPointsAction);
	otherViewBar->addAction(recordOriginMeshAction);
	...
	mouseToolBar->addAction(moveControlPointAction);
	mouseToolBar->addAction(movePositionConstraintsAction);
	mouseToolBar->addAction(moveControlPointsAction);
	mouseToolBar->addAction(selectMoveControlPointsAction);
	mouseToolBar->addAction(clearSelectPointsAction);
...
void SurfaceMeshProcessing::ChangeCageMode()
{
	viewer->change_cage_mode();
}

void SurfaceMeshProcessing::DrawControlPoint()
{
	viewer->set_show_control_point();
}

void SurfaceMeshProcessing::DrawMoveVertices()
{
	viewer->set_show_move_vertices();
}

void SurfaceMeshProcessing::DrawCage()
{
	viewer->set_show_cage();
}

void SurfaceMeshProcessing::GenerateDeformation()
{
	setAllViewActionChecked(false);
	GenerateDeformedMeshAction->setChecked(true);
	viewer->generate_deformation();
	GenerateDeformedMeshAction->setChecked(false);
}

void SurfaceMeshProcessing::GenerateVariationalDeform()
{
	setAllViewActionChecked(false);
	GenerateVariationalDeformAction->setChecked(true);
	viewer->generate_variational_deformation();
	GenerateVariationalDeformAction->setChecked(false);
}

void SurfaceMeshProcessing::GenerateDeformByControlPoint()
{
	setAllViewActionChecked(false);
	GenerateDeformByControlPointAction->setChecked(true);
	viewer->generate_deformation_by_control_points();
	GenerateDeformByControlPointAction->setChecked(false);
}

void SurfaceMeshProcessing::OptimizeControlPoints()
{
	setAllViewActionChecked(false);
	OptimizeControlPointsAction->setChecked(true);
	viewer->optimize_control_points();
	OptimizeControlPointsAction->setChecked(false);
}

void SurfaceMeshProcessing::RecordOriginMesh()
{
	viewer->record_origin_mesh();
}

void SurfaceMeshProcessing::ReadIntegralParaFromFile()
{
	viewer->read_integral_para();
}

void SurfaceMeshProcessing::ReadCageFromFile()
{
	viewer->read_cage();
}

void SurfaceMeshProcessing::ComputeParaForControlPoints()
{
	viewer->compute_para_for_control_points();
}

void SurfaceMeshProcessing::GenerateParaCompleteFlow()
{
	viewer->generate_para_complete_flow();
}
...
void SurfaceMeshProcessing::moveControlPoint()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	moveControlPointAction->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::MOVE_CONTROL_POINT);
}

void SurfaceMeshProcessing::movePositionConstraints()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	movePositionConstraintsAction->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::MOVE_POSITION_CONSTRAINTS);
}

void SurfaceMeshProcessing::selectMoveControlPoints()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	selectMoveControlPointsAction->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::SELECT_MOVE_CONTROL_POINTS);
}

void SurfaceMeshProcessing::moveControlPoints()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	moveControlPointsAction->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::MOVE_CONTROL_POINTS);
}

void SurfaceMeshProcessing::clearSelectPoints()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	viewer->clear_select_points();
}
...
void SurfaceMeshProcessing::setAllMouseActionChecked(bool b)
{
	...
	moveControlPointAction->setChecked(b);
	movePositionConstraintsAction->setChecked(b);
	selectMoveControlPointsAction->setChecked(b);
	moveControlPointsAction->setChecked(b);
